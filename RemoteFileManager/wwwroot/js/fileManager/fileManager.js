...
const connection = new SignalrConnection('/file-manager')
...
function getConnectionStateElement() {
    return getElementById('connectionState')
}

function getReconnectButtonElement() {
    return getElementById('reconnect_button')
}

function getDownloadLinkElement() {
    return getElementById('downloadLink')
}

function getDownloadDirectoriesElement() {
    return getElementById('downloadDirectories')
}

function getDownloadFileNameElement() {
    return getElementById('downloadFileName')
}

function getActiveDownloadsElement() {
    return getElementById('activeDownloads')
}

function getCompletedDownloadsElement() {
    return getElementById('completedDownloads')
}

function getEditDirectoriesElement() {
    return getElementById('editDirectories')
}

function getFileToDeleteElement() {
    return getElementById('fileToDelete')
}
